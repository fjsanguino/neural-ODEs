...
from autograd.extended import primitive, defvjp_argnums
...
def augmented_dynamics (augmented_state, t, flat_args):
    # Original system augmented with vjp_y, vjp_t, vjp_args.
...
def grad_argnums_wrapper (all_vjp_builder) :
    ...
    # build vjps for all arguments, and wraps it to return only required vjps.
